 ...
 */
package com.qiangmen.auth.server.config;

import com.mongodb.DBObject;
import com.qiangmen.auth.server.model.User;
import com.qiangmen.auth.server.service.security.ClientDetailService;
import com.qiangmen.auth.server.service.security.UserAuthConfigService;
...
public class CustomMongoDBConvertor implements Converter<DBObject, OAuth2Authentication> {
	...
	public OAuth2Authentication convert(DBObject source) {
		...
		if (null != userAuthorization) { // its a user
			...
			Authentication userAuthentication = new ClientAuthenticationToken(client.getClientId(), null,
