 ...
 */
package com.qiangmen.auth.server;
...
import com.qiangmen.auth.server.config.CustomMongoDBConvertor;

@Configuration
@EnableAutoConfiguration
@EnableMongoRepositories("com.qiangmen.auth.server.repository")
@ComponentScan
